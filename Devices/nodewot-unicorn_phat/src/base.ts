...
export class WotDevice {
	...
	private config:any; //for unicornphat
	private pixels:any;// always stored in Uint32 array
            ...
            //fill in the empty quotation marks
{
  ...
  actions:{
    ...
    private fillColor(r:number,g:number,b:number){
    ...
    private convertToArray(uintArray:any){
